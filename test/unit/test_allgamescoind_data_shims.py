...
# TODO: remove fixtures below here once test_SHIM_serialise_for_allgamescoind removed
...
@pytest.fixture
def allgamescoind_proposal_hex():
...
@pytest.fixture
def allgamescoind_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_allgamescoind(sentinel_proposal_hex, sentinel_superblock_hex):
    assert allgamescoinlib.SHIM_serialise_for_allgamescoind(sentinel_proposal_hex) == ''
    assert allgamescoinlib.SHIM_serialise_for_allgamescoind(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.allgamescoincentral.org/black-pearl',
