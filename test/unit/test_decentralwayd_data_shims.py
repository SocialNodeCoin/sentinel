...
# TODO: remove fixtures below here once test_SHIM_serialise_for_decentralwayd removed
...
@pytest.fixture
def decentralwayd_proposal_hex():
...
@pytest.fixture
def decentralwayd_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_decentralwayd(sentinel_proposal_hex, sentinel_superblock_hex):
    assert decentralwaylib.SHIM_serialise_for_decentralwayd(sentinel_proposal_hex) == ''
    assert decentralwaylib.SHIM_serialise_for_decentralwayd(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.decentralwaycentral.org/black-pearl',
